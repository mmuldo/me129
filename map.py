...
# demo map 
# N is facing the screwdrivers
# (0, 0) is bottom right corner
demo_map = Map({})
demo_map.add_street(Intersection(0,0), Intersection(0,1))
demo_map.add_street(Intersection(0,0), Intersection(-1,0))
demo_map.add_street(Intersection(0,1), Intersection(0,2))
demo_map.add_street(Intersection(0,1), Intersection(-1,1))
demo_map.add_street(Intersection(-1,0), Intersection(-2,0))
demo_map.add_street(Intersection(0,2), Intersection(-1,2))
demo_map.add_street(Intersection(-1,1), Intersection(-1,2))
demo_map.add_street(Intersection(-1,1), Intersection(-2,1))
demo_map.add_street(Intersection(-2,0), Intersection(-2,1))
demo_map.add_street(Intersection(-2,0), Intersection(-3,0))
demo_map.add_street(Intersection(-2,1), Intersection(-3,1))
demo_map.add_street(Intersection(-3,0), Intersection(-3,1))

# level 2 map
# N is facing monitors and router
# (0, 0) is bottom left
level2 = Map({})
level2.add_street(Intersection(0,0), Intersection(1,0))
level2.add_street(Intersection(0,0), Intersection(0,1))
level2.add_street(Intersection(1,0), Intersection(2,0))
level2.add_street(Intersection(1,0), Intersection(1,1))
level2.add_street(Intersection(2,0), Intersection(2,1))
level2.add_street(Intersection(1,1), Intersection(1,2))
level2.add_street(Intersection(2,1), Intersection(3,1))
level2.add_street(Intersection(2,1), Intersection(2,2))
level2.add_street(Intersection(1,2), Intersection(0,2))
level2.add_street(Intersection(1,2), Intersection(2,2))
level2.add_street(Intersection(3,1), Intersection(3,0))
level2.add_street(Intersection(3,1), Intersection(3,2))
level2.add_street(Intersection(2,2), Intersection(3,2))
level2.add_street(Intersection(3,2), Intersection(3,3))

# level 1+
# N is facing monitors and router
# (0, 0) is bottom left
level1_plus = Map({})
level1_plus.add_street(Intersection(0,0), Intersection(1,0))
level1_plus.add_street(Intersection(0,0), Intersection(0,1))
level1_plus.add_street(Intersection(1,0), Intersection(2,0))
level1_plus.add_street(Intersection(1,0), Intersection(1,1))
level1_plus.add_street(Intersection(0,1), Intersection(1,1))
level1_plus.add_street(Intersection(0,1), Intersection(0,2))
level1_plus.add_street(Intersection(2,0), Intersection(3,0))
level1_plus.add_street(Intersection(1,1), Intersection(2,1))
level1_plus.add_street(Intersection(1,1), Intersection(1,2))
level1_plus.add_street(Intersection(0,2), Intersection(1,2))
level1_plus.add_street(Intersection(3,0), Intersection(3,1))
level1_plus.add_street(Intersection(2,1), Intersection(3,1))
level1_plus.add_street(Intersection(2,1), Intersection(2,2))
level1_plus.add_street(Intersection(1,2), Intersection(2,2))
